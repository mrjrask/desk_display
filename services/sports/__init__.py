...
from .ncaam import (
    fetch_scoreboard as fetch_ncaam_scoreboard,
    scoreboard_date as ncaam_scoreboard_date,
)
from .nfl import (
...
from .world_cup import (
    fetch_scoreboard as fetch_world_cup_scoreboard,
    scoreboard_date as world_cup_scoreboard_date,
)
