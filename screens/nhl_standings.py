...
TITLE_SUBTITLE_DIVISION = "Division Standings"
...
TITLE_SUBTITLE_GAP = scale_value(2)
DIVISION_MARGIN_TOP = scale_value(4)
...
if is_hyperpixel_4_square_layout():
    OVERVIEW_TITLE_WEST = "NHL West"
    OVERVIEW_TITLE_EAST = "NHL East"
OVERVIEW_DIVISIONS = [
...
def _render_conference(
    ...
    if subtitle:
        ...
        y += _draw_centered_text(draw, subtitle, TITLE_FONT, y)
...
def _render_empty(
    ...
    if subtitle:
        y += TITLE_SUBTITLE_GAP
        _draw_centered_text(draw, subtitle, TITLE_FONT, y)
