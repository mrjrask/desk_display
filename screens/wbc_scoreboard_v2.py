...
from screens.wbc_scoreboard import (
...
@log_call
def draw_wbc_scoreboard_v2(display, transition: bool = False) -> ScreenImage:
    games = _fetch_games_for_date(_scoreboard_date())
    return render_wbc_scoreboard_v2(display, games, transition=transition)
