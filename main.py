...
def _load_air_quality_history(now: float) -> List[Tuple[float, Optional[int], Optional[int], Optional[int]]]:
    ...
    return feeds.load_air_quality_history(_AIR_QUALITY_HISTORY_PATH, now)
...
def _save_air_quality_history(history: List[Tuple[float, Optional[int], Optional[int], Optional[int]]]) -> None:
    ...
    feeds.save_air_quality_history(_AIR_QUALITY_HISTORY_PATH, history)


_FEED_DEPENDENCIES: Dict[str, Set[str]] = feeds.FEED_DEPENDENCIES
_FEED_REFRESH_INTERVALS: Dict[str, int] = feeds.FEED_REFRESH_INTERVALS
_SCOREBOARD_SCREEN_IDS = feeds.SCOREBOARD_SCREEN_IDS
_SCOREBOARD_SCREEN_TO_LEAGUES: Dict[str, Set[str]] = feeds.SCOREBOARD_SCREEN_TO_LEAGUES
_LIVE_TEAM_SCREEN_TO_FEED: Dict[str, str] = feeds.LIVE_TEAM_SCREEN_TO_FEED
...
_STARTUP_CRITICAL_FEEDS: Tuple[str, ...] = feeds.STARTUP_CRITICAL_FEEDS
...
_scoreboard_date_for_league = feeds.scoreboard_date_for_league
...
_is_live_scoreboard_game = feeds.is_live_scoreboard_game
_scoreboards_have_live_games = feeds.scoreboards_have_live_games
_LIVE_GAME_LEAD_IN = feeds.LIVE_GAME_LEAD_IN
_is_terminal_scoreboard_game = feeds.is_terminal_scoreboard_game
_scoreboard_game_start = feeds.scoreboard_game_start
_scoreboards_in_live_window = feeds.scoreboards_in_live_window
