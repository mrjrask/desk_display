...
DESK_DISPLAY_PROFILE="${DESK_DISPLAY_PROFILE:-hyperpixel_pi_zero}"
DESK_DISPLAY_LOW_POWER="${DESK_DISPLAY_LOW_POWER:-1}"
export DESK_DISPLAY_PROFILE DESK_DISPLAY_LOW_POWER
ENV_LINES=()
ENV_LINES+=("DESK_DISPLAY_OUTPUT=${DESK_DISPLAY_OUTPUT}")
ENV_LINES+=("DESK_DISPLAY_PROFILE=${DESK_DISPLAY_PROFILE}")
ENV_LINES+=("DESK_DISPLAY_LOW_POWER=${DESK_DISPLAY_LOW_POWER}")
